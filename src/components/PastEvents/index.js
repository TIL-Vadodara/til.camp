...
const LoadingPlaceholders = () => (
  <div className={classNames.eventListItemPlaceholder}>
    <div className={classNames.dateBoxPlaceholder} />

    <div className={classNames.textBoxPlaceholder}>
      <div className={classNames.titlePlaceholder} />
      <div className={classNames.descriptionPlaceholder} />
        ...
        {type &&
          type.name != 'Talk' && (
            <div className={classNames.eventTypeBox}>
              {type.name == 'Watch and Talk' && (
                <WatchAndTalk className={classNames.typeIcon} />
              )}
